...
class ActiveFranchiseTaxPermitHolders:
    ...
    Example:
        ...
        >>> results = resource.for_city("Austin").for_org_type("CT").limit(50).get()
    ...
    def exempt_start_before(self, date: str):
        """
    ...
    def exempt_start_after(self, date: str):
        """
    ...
    def exempt_start_between(self, start: str, end: str):
        """
