...
from data.client import ComptrollerClient
from data.resources import SalesTaxResource, FranchiseResource, MixedBeverageResource


def test_comptroller_client_factory(monkeypatch):
    with patch("data.client.SocrataClient") as MockSocrata:
