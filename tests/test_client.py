...
from compytroller.client import ComptrollerClient
from compytroller.resources import SalesTaxResource, FranchiseResource, MixedBeverageResource


def test_comptroller_client_factory(monkeypatch):
    with patch("compytroller.client.SocrataClient") as MockSocrata:
